...
const useCases = [
  ...
  {
    title: "Nike Air Jordan 1 for Designer Jacket",
    description:
      "Seun in Bodija, Ibadan trades his barely used Nike Air Jordans for a stylish Zara leather jacket from another student in UI campus",
    icon: ShoppingBag,
    image: "/images/nike-sneakers.jpg",
  ...
  {
    title: "Microwave Oven for Home Theater",
    description:
      "A trader in Abeokuta exchanges his LG microwave for a booming Sony Home Theater system from another user in Lafenwa",
    icon: Package,
    image: "/images/microwave-home-theater.jpg",
    location: "Ogun State (Abeokuta)",
    category: "Appliances → Electronics",
    value: "₦95,000 worth",
    gradient: "from-yellow-500 to-amber-600",
    naija_phrase: "Correct swap! 🎛️🎶",
  }
];

// Sample featured items (only Lagos, Oyo, Ogun)
...
const stats = [
  {
    ...
    bg: "bg-emerald-100",
    naija: "🇳🇬",
    description: "Active users trading across communities",
  },
  {
    ...
    bg: "bg-blue-100",
    naija: "💪",
    description: "Verified product-for-product exchanges completed",
  },
  {
    ...
    bg: "bg-purple-100",
    naija: "📦",
    description: "From electronics to groceries — value meets value",
  },
  {
    ...
    bg: "bg-orange-100",
    naija: "🌍",
    description: "Lagos, Ibadan & Abeokuta live — Naija-wide next!",
  },
];
